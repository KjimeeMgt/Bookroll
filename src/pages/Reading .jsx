    ...
    <div className="flex h-screen bg-[#12060f] overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto px-8 py-6">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-[#f0e0c8] font-serif text-2xl font-medium">Leyendo</h1>
            <p className="text-[#a08070] text-sm">Tu lectura actual</p>
          </div>
        ...
        {libros.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-64 gap-4 text-center">
            <div className="w-16 h-16 rounded-2xl bg-[#1c0e0e] border border-[#3d2020] flex items-center justify-center">
              <BookOpen size={32} className="text-[#3d2020]" />
            </div>
            <p className="text-[#a08070] text-sm max-w-xs">
              Aún no tienes libros aquí. Ve a{" "}
              <span className="text-[#f0e0c8]">Agregar libro</span> y etiquétalos como "Leyendo".
            </p>
          </div>
        ) : (
